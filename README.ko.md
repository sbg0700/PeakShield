...
모터/콘덴서 가동률을 재스케줄링하여 **전기요금(기본료·전력량요금·역률 페널티)과 피크 수요를 최소화**하고, 탄소배출량은 대시보드에서 함께 모니터링하는
...
3인 팀. 데이터/디지털 트윈 · 요금·ROI/프론트엔드 · 모델링으로 역할 분담.
...
- **송병갑 ([@sbg0700](https://github.com/sbg0700))** — 요금·ROI 엔진 & 프론트엔드. 타겟 피처 엔지니어링, KEPCO 전기요금 산출 함수, 탄소배출권 가격 API 연동, 대시보드 프론트엔드(전기료·탄소 탭).
